...
[フレンド追加による参加](/docs/wolf/how-to-join/join-with-friend)の場合は、特殊な操作なしにそのままご参加いただけます。  
[サーバーアドレスによる参加](/docs/wolf/how-to-join/join-with-address)の場合は、以下の特殊な操作が必要になります。  
