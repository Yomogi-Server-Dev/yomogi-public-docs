...
タイムアウトの場合は、最後の処罰から1か月が経過した後はサーバーにご参加いただけます(詳しくは[処罰に関する補足事項](https://docs.ymg24.org/docs/living/supplement/sanction)をご覧ください)。
...
[PC/スマートフォン以外のデバイスからでも参加できますか？](https://docs.ymg24.org/docs/living/faq/device)をご覧ください。

### 「近距離VC https://vc.ymg24.org に参加してください」と出る場合

近距離VCに参加してください。何らかの問題が発生して参加ができない場合は、[近距離VCに参加できません](https://docs.ymg24.org/docs/living/faq/lvc-faults)をご覧ください。  
