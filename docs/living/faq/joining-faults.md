...
なお、生活サーバーのアドレスは`ymg24.org`、ポート番号は`19132`です。
...
① 数分ほど待ってから、再度お試しください  
② [サーバーアドレスによる参加](/docs/living/how-to-join/join-with-address)をご検討ください  
...
タイムアウトの場合は、最後の処罰から1か月が経過した後はサーバーにご参加いただけます(詳しくは[処罰に関する補足事項](/docs/living/supplement/sanction)をご覧ください)。
...
[PC/スマートフォン以外のデバイスからでも参加できますか？](/docs/living/faq/device)をご覧ください。

### 「近距離VC https://vc.ymg24.org に参加してください」と出る場合

近距離VCに参加してください。何らかの問題が発生して参加ができない場合は、[近距離VCに参加できません](/docs/living/faq/lvc-faults)をご覧ください。  
