...
よもぎサーバーでは、[会社プラグイン](https://docs.ymg24.org/docs/living/commands/company)を使用して設立された会社のうち、特にステークホルダー(社員や取引先といった、その会社に関わる人たち)への配慮と持続的な成長を重要視している会社を「優良企業」とし、申請のあった優良企業に支援金や宣伝支援を行う制度(公認企業制度)を設けています。  
...
:::info
第7条では、「事実上の時給が5,000YG以上になるようにし、新規プレイヤーを差別しないようにしましょう」ということが定められています。
:::
...
:::info
第9条では、「最低でも週に2時間は会社を動かしましょう」「運営の質問には答えましょう」ということが定められています。
:::
...
・新規プレイヤーとの取引の際は、24時間以内の返品を受け付ける必要があります  
・「ぼったくり」をしてはいけません  
・転売をする際は、だれから仕入れたかを客に伝えなければなりません  
