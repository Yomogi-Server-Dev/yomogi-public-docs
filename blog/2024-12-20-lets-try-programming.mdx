...
authors: [aida]
tags: [developments, php, programming, tutorial]
---
...
このようにechoを使うと、このように好きな文字列を出力できるんです。
...
このように、**while文**を使うと条件が満たされている間、処理を繰り返すことができます。
...
クラスを使うと、**データと処理を一つにまとめたり**、処理が読みやすくなったり便利な機能が使えるようになります。
